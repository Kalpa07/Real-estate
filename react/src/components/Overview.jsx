...
const Overview = () => {
  ...
  useEffect(() => {
    gsap.fromTo(
      ".floating-icon",  // Targeting all elements with the "floating-icon" class
      { rotate: -25 },
      {
        rotate: 25,
        scrollTrigger: {
  ...
  return (
    <div className="h-screen w-full bg-neutral flex items-center justify-center relative">
      {/* Floating icons/images placed outside of the polaroid */}
    <img
  src="/headerbg.png" // replace with real path
  alt="icon1"
